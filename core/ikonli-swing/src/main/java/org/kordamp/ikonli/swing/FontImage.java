 ...
 */
public class FontImage extends FontIcon {
    ...
    public static FontImage of(Ikon ikon) {
        return of(ikon, 8, Color.BLACK);
    }

    public static FontImage of(Ikon ikon, int iconSize) {
        return of(ikon, iconSize, Color.BLACK);
    }

    public static FontImage of(Ikon ikon, Color iconColor) {
        return of(ikon, 8, iconColor);
    }

    public static FontImage of(Ikon ikon, int iconSize, Color iconColor) {
        FontImage icon = new FontImage();
        icon.setIkon(ikon);
    ...
    /**
     * Get font symbol image.
     * @return font symbol image
     */
    ...
    /**
     * Draw font symbol to BufferedImage.
     * @return font symbol image
     */
    private BufferedImage drawImage() {
        BufferedImage symbolImage = new BufferedImage(getIconWidth(), getIconHeight(),
